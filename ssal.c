...
// defines the class, which is just a typedef
// this is separated to make header only and header+source possible
#define class(...) \
    typedef struct __VA_ARGS__ ## _VTable __VA_ARGS__ ## _VTable; \
    typedef struct __VA_ARGS__ ## _Ptr __VA_ARGS__ ## _Ptr; \
    typedef struct __VA_ARGS__ __VA_ARGS__;
...
#define dynamic_cast(From, To) \
    ((To *)(-offsetof(To, From) + (char *)(0 ? (From *)0 : DYNAMIC_CAST_

// same as interface, but without types and fields
// to be used inside source (.c) with class macro in accompanying header (.h)
#define implementation(Class, ...) MAP_UD(CLASS0_, Class, __VA_ARGS__)

// actual class definition with name and selectors
// 1. predeclares v-table with CLASS1_, fat pointer, and class for inner usage
// 2. and the fields expanded by CLASS2_
// 3. defines methods as free functions with implementation
...
#define interface(Class, ...) \
    struct Class ## _VTable { MAP_UD(CLASS1_, Class, __VA_ARGS__) }; \
    struct Class ## _Ptr { \
        struct Class *_; \
        const struct Class ## _VTable *v; \
    }; \
    struct Class { MAP(CLASS2_, __VA_ARGS__) }; \
    implementation(Class, __VA_ARGS__)

// second part of dynamic_cast, for cast(Types...)(Expr) syntax
...
#define EXPAND2_(X, ...) X __VA_ARGS__
#define EXPAND2(...)     EXPAND2_(__VA_ARGS__)

// outer generation (top level) of extends selectors
// (this expands to nothing)
#define OUTER_EXTENDS(...)
#define OUTER0_extends(...) OUTER_EXTENDS
#define OUTER1_extends(...) __VA_ARGS__

// outer generation of method selectors
...
#define OUTER_METHOD(Class, method, Return, ...) \
    Return Class ## _ ## method(struct Class OUTER_METHOD_ __VA_ARGS__;
...
// outer generation of static method selectors
// (this expands to normal class-named functions w/o class name argument)
#define OUTER_STATIC_METHOD(Class, method, Return, ...) \
    Return Class ## _ ## method __VA_ARGS__;
#define OUTER0_static_method(...) OUTER_STATIC_METHOD
#define OUTER1_static_method(...) __VA_ARGS__

// outer generation of static property selectors
// (this expands to global class-named static variables)
#define OUTER_STATIC_PROPERTY(Class, property, Type, ...) \
    Type Class ## _ ## property = __VA_ARGS__;
#define OUTER0_static_property(...) OUTER_STATIC_PROPERTY
#define OUTER1_static_property(...) __VA_ARGS__

// outer generation of type selectors
// (this expands to global class-named typedefs)
#define OUTER_TYPE(Class, Type, ...) typedef __VA_ARGS__ Class ## _ ## Type;
#define OUTER0_type(...)             OUTER_TYPE
#define OUTER1_type(...)             __VA_ARGS__

// outer generation of virtual method selectors
// (this expands to normal class-named functions with class name argument)
#define OUTER_VIRTUAL_METHOD_(...) __VA_ARGS__
#define OUTER_VIRTUAL_METHOD(Class, method, Return, Args, ...) \
    Return Class ## _ ## method( \
        struct Class OUTER_VIRTUAL_METHOD_ Args \
    ) __VA_ARGS__;
#define OUTER0_virtual_method(...) OUTER_VIRTUAL_METHOD
#define OUTER1_virtual_method(...) __VA_ARGS__
...
// EXPAND2 is needed to make this actually expand
#define CLASS0_(selector, ...) \
    EXPAND2(OUTER0_ ## selector, (__VA_ARGS__, OUTER1_ ## selector))

// virtual generation (within v-table) of extends selectors
// (this expands to nothing)
#define VIRTUAL_EXTENDS_(...) \
    struct __VA_ARGS__ ## _VTable __VA_ARGS__ ## _VTable;
#define VIRTUAL_EXTENDS(Class, ...) \
    DEFER(MAP0)(VIRTUAL_EXTENDS_, __VA_ARGS__, ()()(), ()()(), ()()(), 0)
#define VIRTUAL0_extends(...) VIRTUAL_EXTENDS
#define VIRTUAL1_extends(...) __VA_ARGS__

// virtual generation of method selectors
// (this expands to nothing)
#define VIRTUAL_METHOD(...)
#define VIRTUAL0_method(...) VIRTUAL_METHOD
#define VIRTUAL1_method(...) __VA_ARGS__

// virtual generation of property selectors
// (this expands to nothing)
#define VIRTUAL_PROPERTY(...)
#define VIRTUAL0_property(...) VIRTUAL_PROPERTY
#define VIRTUAL1_property(...) __VA_ARGS__

// virtual generation of static method selectors
// (this expands to nothing)
#define VIRTUAL_STATIC_METHOD(...)
#define VIRTUAL0_static_method(...) VIRTUAL_STATIC_METHOD
#define VIRTUAL1_static_method(...) __VA_ARGS__

// virtual generation of static property selectors
// (this expands to nothing)
#define VIRTUAL_STATIC_PROPERTY(...)
#define VIRTUAL0_static_property(...) VIRTUAL_STATIC_PROPERTY
#define VIRTUAL1_static_property(...) __VA_ARGS__

// virtual generation of type selectors
// (this expands to nothing)
#define VIRTUAL_TYPE(...)
#define VIRTUAL0_type(...) VIRTUAL_TYPE
#define VIRTUAL1_type(...) __VA_ARGS__

// virtual generation of virtual method selectors
// (this expands to function fields with class name argument)
#define VIRTUAL_VIRTUAL_METHOD_(...) __VA_ARGS__
#define VIRTUAL_VIRTUAL_METHOD(Class, method, Return, Args, ...) \
    Return (*method)(struct Class VIRTUAL_VIRTUAL_METHOD_ Args);
#define VIRTUAL0_virtual_method(...) VIRTUAL_VIRTUAL_METHOD
#define VIRTUAL1_virtual_method(...) __VA_ARGS__

// selector for virtual generation
// first gets selector args by forming VIRTUAL1_method or VIRTUAL1_property
// then wraps class name with args in parens and forms VIRTUAL0_method/property
// EXPAND2 is needed to make this actually expand
#define CLASS1_(selector, ...) \
    EXPAND2(VIRTUAL0_ ## selector, (__VA_ARGS__, VIRTUAL1_ ## selector))

// inner generation (inside struct) of extends selectors
// (this expands to nothing)
#define INNER_EXTENDS(...) struct __VA_ARGS__ __VA_ARGS__;
#define INNER_extends(...) \
    DEFER(MAP0)(INNER_EXTENDS, __VA_ARGS__, ()()(), ()()(), ()()(), 0)

// inner generation of method selectors
// (this expands to nothing)
#define INNER_method(...)
...
// inner generation of static method selectors
// (this expands to nothing)
#define INNER_static_method(...)

// inner generation of static property selectors
// (this expands to nothing)
#define INNER_static_property(...)

// inner generation of type selectors
// (this expands to nothing)
#define INNER_type(...)

// inner generation of virtual method selectors
// (this expands to nothing)
#define INNER_virtual_method(...)
